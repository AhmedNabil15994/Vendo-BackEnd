                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea name="description[{{ $code }}]" rows="8" cols="80"
                                                                class="form-control {{ is_rtl($code) }}Editor" data-name="description.{{ $code }}">{{ $company->getTranslation('description', $code) }}</textarea>
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            @if (config('setting.other.select_shipping_provider') == 'shipping_company')
                                                    ...
                                                    <div class="col-md-8">
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" id="deliveryTimeDirectCheckbox"
                                                                ...
                                                                @if (in_array('direct', $company->delivery_time_types ?? [])) checked @endif>
                                                            {{ __('company::dashboard.companies.form.delivery_time_types.direct') }}
                                                        </label>
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="delivery_time_types[]"
                                                                value="schedule"
                                                                @if (in_array('schedule', $company->delivery_time_types ?? [])) checked @endif>
                                                ...
                                                <div class="form-group" id="deliveryTimeMessageContent"
                                                    style="display: {{ in_array('direct', $company->delivery_time_types ?? []) ? 'block' : 'none' }}">
                                                    <label
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="col-md-12">
                                                                            <input type="text"
                                                                                ...
                                                                                class="form-control"
                                                                                value="{{ $company->getTranslation('direct_delivery_message', $code) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="email" name="email" class="form-control"
                                                    data-name="email" value="{{ $company->email }}">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
