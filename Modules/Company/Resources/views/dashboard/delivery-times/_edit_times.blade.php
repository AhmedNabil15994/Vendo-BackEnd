        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                @foreach (getDays() as $k => $day)
                        ...
                        <td>
                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                <input type="checkbox" class="group-checkable"
                                    {{ $company->deliveryTimes()->where('day_code', $k)->value('status') == 1? 'checked': '' }}
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                {{-- <span class="is_full_day">
                                    <input class="form-check-input check-time" type="radio"
                                        ...
                                        value="1"
                                        {{ $company->deliveryTimes()->where('day_code', $k)->first() == null ||$company->deliveryTimes()->where('day_code', $k)->first()->is_full_day == 1? 'checked': '' }}
                                ...
                                <span class="is_full_day">
                                    <input class="form-check-input check-time" type="radio"
                                        ...
                                        value="0"
                                        {{ $company->deliveryTimes()->where('day_code', $k)->first() == null ||(isset($company->deliveryTimes()->where('day_code', $k)->first()->is_full_day) && $company->deliveryTimes()->where('day_code', $k)->first()->is_full_day == 0)? 'checked': '' }}
                    ...
                    @if (isset(
    $company->deliveryTimes()->where('day_code', $k)->first()->is_full_day,
) &&
    $company->deliveryTimes()->where('day_code', $k)->first()->is_full_day == 0)
                        <tr id="collapse-{{ $k }}" class="">
                            <td colspan="3" id="div-content-{{ $k }}">
                                ...
                                @foreach ($company->deliveryTimes()->where('day_code', $k)->first()->custom_times
    as $key => $time)
