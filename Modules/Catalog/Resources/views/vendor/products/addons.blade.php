                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody id="allAddOnsTable">
                                            ...
                                            <tr id="addOnsRow-{{ $value->id }}">
                                                <td>{{ optional($value->addonCategory)->getTranslation('title', locale()) }}</td>
                                                <td>
...
<script>
    var select2AddonCategory = $('.select2AddonCategory');
        ...
        function getAddonOptionContent(addonCategoryId) {
            $.ajax({
                url: "{{route('vendor.addon_options.get_by_addon_category')}}?product_id={{ $product->id }}&addon_category_id=" + addonCategoryId,
                type: 'get',
                dataType: 'JSON',
                contentType: false,
                cache: false,
        ...
        function openAddOnsDetails(rowId) {
            ...
            $.ajax({
                url: "{{route('vendor.addon_options.get_addon_details')}}?product_addon_id=" + rowId,
                type: 'get',
                dataType: 'JSON',
                contentType: false,
                cache: false,
