...
use Modules\Catalog\Repositories\Vendor\ProductAddonRepository as ProductAddon;
use Modules\Catalog\Transformers\Vendor\ProductAddonResource;
...
class ProductAddonsController extends Controller
{
    ...
    public function addOns($id)
    {
        ...
        return view('catalog::vendor.products.addons', compact('product'));
    }
