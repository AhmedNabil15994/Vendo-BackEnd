...
use Modules\Catalog\Http\Requests\Vendor\AddonOptionRequest;
use Modules\Catalog\Repositories\Vendor\AddonOptionRepository as AddonOption;
use Modules\Catalog\Transformers\Vendor\AddonDetailsResource;
use Modules\Catalog\Transformers\Vendor\AddonOptionResource;
use Modules\Catalog\Transformers\Vendor\CustomAddonCategoryResource;
use Modules\Catalog\Transformers\Vendor\SimpleAddonOptionsResource;
...
class AddonOptionsController extends Controller
{
    ...
    public function __construct(AddonOption $addonOption)
    {
    ...
    {
        return view('catalog::vendor.addon_options.index');
    }
    ...
    public function getAddonDetails(Request $request)
    {
        ...
        if (is_null($addon->addonCategory)) {
            return Response()->json(['status' => false, 'data' => __('catalog::dashboard.products.form.add_ons.addons_category_not_found')]);
        }
    ...
    {
        return view('catalog::vendor.addon_options.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('catalog::vendor.addon_options.show');
    }
    ...
    public function edit($id)
    {
        ...
        return view('catalog::vendor.addon_options.edit', compact('addonOption'));
    }
    ...
    public function getAddonCategoriesByVendor(Request $request)
    {
        $items = $this->addonOption->getAddonCategoriesByVendor($request->vendor_id);
        return Response()->json([true, 'data' => CustomAddonCategoryResource::collection($items)]);
    }
}
